CUDA_VISIBLE_DEVICES=1 python main.py --datname cora --random True --att 0.66 --dropout 0.061 --l1 0.46 --lap 0.9 --lr 0.025 --nbsz 20 --ncaps 12 --nhidden 52 --nlayer 7 --reg 0.003 --routit 6 --iterat 8
...
CUDA_VISIBLE_DEVICES=2 python main.py --datname pubmed --random True --att 0.062 --dropout 0.17 --l1 0.49 --lap 1 --lr 0.064 --nbsz 20 --ncaps 12 --nhidden 36 --nlayer 6 --reg 9.4e-05 --routit 6 --iterat 8
